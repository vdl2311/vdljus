    ...
    <div className="p-6 space-y-6 overflow-y-auto h-full bg-background transition-colors">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-4 bg-card border border-border/80 rounded-xl shadow-sm flex flex-col justify-between">
          ...
          <div className="mt-2">
            {" "}
            <p className="text-2xl font-black text-foreground font-sans tracking-tight">
              {" "}
              {activeProcesses}{" "}
        ...
        <div className="p-4 bg-card border border-border/80 rounded-xl shadow-sm flex flex-col justify-between">
          ...
          <div className="mt-2">
            {" "}
            <p
              className={`text-lg font-black font-sans tracking-tight ${netBalance >= 0 ? "text-emerald-600 dark:text-emerald-400" : "text-rose-600 dark:text-rose-400"}`}
            >
              {" "}
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex gap-3 text-[10px] font-semibold">
              ...
              <span className="flex items-center gap-1">
                <span className="w-2.5 h-2.5 bg-cyan-500 rounded-sm" /> Receitas
              </span>{" "}
              <span className="flex items-center gap-1">
                ...
                >
                  ...
                  <div className="w-full flex justify-center gap-1 items-end h-full">
                    ...
                    <div
                      ...
                      className="w-3 sm:w-4 bg-cyan-500 hover:bg-cyan-600 rounded-t-sm transition-all duration-300 relative"
                    >
                      {" "}
                      {/* Tooltip on hover */}{" "}
                      <span className="absolute bottom-full left-1/2 -translate-x-1/2 bg-card text-white text-[9px] py-1 px-1.5 rounded scale-0 group-hover:scale-100 whitespace-nowrap transition-all z-10">
                        {" "}
        ...
        <div className="p-5 bg-card border border-border/80 rounded-xl shadow-sm flex flex-col">
          ...
          <div className="flex justify-between items-center mb-3">
            ...
            <h3 className="text-xs font-bold text-foreground uppercase tracking-wider flex items-center gap-1.5">
              {" "}
              <Calendar className="w-4 h-4 text-cyan-500" /> Prazos do Dia &
              Críticos{" "}
            </h3>{" "}
            <button
              onClick={() => setActiveTab("operacao.prazos")}
              className="text-[10px] text-cyan-600 dark:text-cyan-400 hover:underline font-bold flex items-center gap-1"
            >
              {" "}
      ...
      <div className="p-5 bg-gradient-to-tr from-slate-900 to-indigo-950 text-white rounded-xl border border-indigo-950 shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10 text-left">
          ...
          <div className="flex items-center gap-2">
            {" "}
            <div className="p-1.5 bg-cyan-500 text-white rounded-md">
              {" "}
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <button
              ...
              className="px-3.5 py-1.5 bg-cyan-500 hover:bg-cyan-600 text-slate-950 font-bold text-xs rounded-md transition-colors flex items-center gap-1.5 shadow-md shadow-cyan-500/15"
            >
              {" "}
