  ...
  return (
    <div className="h-16 border-b flex items-center justify-between px-3 sm:px-6 bg-background/80 backdrop-blur-md border-border transition-colors z-20 shrink-0 sticky top-0">
      ...
      <div className="flex items-center gap-1.5 sm:gap-4">
        ...
        >
          {" "}
          <MessageSquareShare className="w-5 h-5 text-cyan-500 dark:text-cyan-400" />{" "}
          <span className="absolute top-1 right-1 w-2 h-2 bg-gradient-to-r from-cyan-400 to-indigo-500 rounded-full animate-ping" />{" "}
        </button>{" "}
        {/* Theme Switcher */}{" "}
        <button
        ...
        <div className="relative">
          ...
          >
            {" "}
            <div className="w-8 h-8 rounded-full bg-cyan-600 text-white font-bold flex items-center justify-center shadow-md">
              {" "}
